...
_TABLE_ATTRIBUTES = {"Interpolate": SECTION_DEFINE, "Extrapolate": SECTION_DEFINE}

_TABLE1D_ATTRIBUTES = {"Below": SECTION_DEFINE, "Above": SECTION_DEFINE}
...
_PROCESS_ATTRIBUTES = {"Feeds": SECTION_DEFINE, "Conversions": SECTION_BOTH}

_PRODUCER_ATTRIBUTES = {
...
_REPORT_ATTRIBUTES = {"Directory": SECTION_DEFINE, "FileFormat": SECTION_DEFINE}
...
_TECHNOLOGY_ATTRIBUTES = {**_MACHINERY_ATTRIBUTES, "ShorePowerCapacity": SECTION_BOTH}


_TIMETABLE_ATTRIBUTES = {
    "Table": SECTION_BOTH,
    **_CALCULATOR_ATTRIBUTES,
    **_TABLE_ATTRIBUTES,
    **_TABLE2D_ATTRIBUTES,
...
_VARIABLE_ATTRIBUTES = {**_CALCULATOR_ATTRIBUTES, "Value": SECTION_BOTH}
