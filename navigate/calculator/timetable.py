...
from navigate.calculator._table2d import Table2D, check_table2D_input
from navigate.calculator._table_data import TableData, build_table_2d
...
class Timetable(Node, Table2D):
    def __init__(self, name: str) -> None:
        Node.__init__(self, name)
        Table2D.__init__(self)
