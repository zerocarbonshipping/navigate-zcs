...
from navigate.output.plots.engine_age import plot_engine_age
from navigate.output.plots.engine_fuel_consumed import plot_engine_fuel_consumed
from navigate.output.plots.engine_pilot_fuel_share import plot_engine_pilot_fuel_share
from navigate.output.plots.fleet_changes import plot_fleet_changes
from navigate.output.plots.fleet_conversions import plot_fleet_conversions_cumulative
from navigate.output.plots.fleet_emission_absolute import plot_fleet_emission_absolute
from navigate.output.plots.fleet_emission_intensity import plot_fleet_emission_intensity
from navigate.output.plots.fleet_energy_saving import plot_fleet_energy_saving
from navigate.output.plots.fleet_evolution import plot_fleet_evolution
from navigate.output.plots.fleet_fuel_consumed import plot_fleet_fuel_consumed
from navigate.output.plots.fleet_investment_metric import plot_fleet_investment_metric
from navigate.output.plots.fleet_investment_signal_per_vessel import (
    plot_fleet_investment_signal_speed_per_vessel,
    plot_fleet_investment_signal_technology_per_vessel,
)
from navigate.output.plots.fleet_shore_power_share import plot_fleet_shore_power_share
from navigate.output.plots.fleet_speed import plot_fleet_speed
from navigate.output.plots.fleet_speed_per_vessel import plot_fleet_speed_per_vessel
from navigate.output.plots.fleet_trade import plot_fleet_trade
