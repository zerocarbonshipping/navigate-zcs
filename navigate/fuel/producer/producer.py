...
from navigate.asset import AssetManager, Increment
...
class Producer(AssetManager):
    def __init__(self, name):
        ...
        # internal properties ------------------------------------------------------------------------------------------
        # pipeline increments (Producer-specific, separate from active increments in AssetManager)
