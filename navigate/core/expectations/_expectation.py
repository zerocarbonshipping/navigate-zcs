...
class _Expectation:
    ...
    def _default_dict_float(
        self, keys: Iterable[Any], default: float | None = None
    ) -> dict[Any, float]:
        return {key: self._default_float(default) for key in keys}

    def _default_dict_array(
        self, keys: Iterable[Any], default: float | bool | None = None
    ) -> dict[Any, np.ndarray]:
    ...
    def _default_dict_list_array(
        self, keys: Iterable[Any], length: int, default: float | bool | None = None
