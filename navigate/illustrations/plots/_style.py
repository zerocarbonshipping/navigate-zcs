...
:mod:`navigate.illustrations.plots._labels`. The catalogue of selectable plot
labels is derived from :mod:`navigate.illustrations.plots._registry`.
"""

import matplotlib as mpl

from navigate.illustrations._fonts import setup_font
